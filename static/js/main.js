...
(function (b) {
    b.fn.floatingWhatsApp = function (r) {
        const j = b.extend({
            ...
            zIndex: '99999',
            avatar: 'https://res.cloudinary.com/dtzjjidjw/image/upload/v1683402102/1610705812476_yaydmj.jpg',
            avatarName: "MonchoDeveloper",
            avatarRole: "Support",
        ...
        const i = b(document.createElement("div"));
        const d = b(document.createElement("div"));
        const f = b(document.createElement("div"));
        const g = b(document.createElement("div"));
        const o = b(document.createElement("div"));
        const m = b(document.createElement("div"));
        ...
        if (j.showPopup) {
            const n = b(document.createElement("textarea"));
            const l = b(document.createElement("strong"));
            const q = b('<?xml version="1.0" encoding="UTF-8" standalone="no"?><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="0 0 20 18" width="20" height="18"><defs><clipPath id="_clipPath_fgX00hLzP9PnAfCkGQoSPsYB7aEGkj1G"><rect width="20" height="18"/></clipPath></defs><g clip-path="url(#_clipPath_fgX00hLzP9PnAfCkGQoSPsYB7aEGkj1G)"><path d=" M 0 0 L 0 7.813 L 16 9 L 0 10.188 L 0 18 L 20 9 L 0 0 Z " fill="rgb(46,46,46)"/></g></svg>');
